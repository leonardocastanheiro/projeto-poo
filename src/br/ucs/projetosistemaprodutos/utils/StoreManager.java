...
public class StoreManager {
    public void save(Store store) throws Exception {
        try (FileOutputStream fileOutputStream = new FileOutputStream("projeto-poo-master/store.dat")){
    ...
    public Store read() throws Exception {
        try (FileInputStream fileInputStream = new FileInputStream("projeto-poo-master/store.dat")){
